...
Dự án thiết kế bộ mã hóa/giải mã **AES-256** hoạt động ở chế độ **Counter (CTR)** bằng ngôn ngữ Verilog.

## 📌 Tính năng chính (Key Features)
* **Algorithm:** AES-256 (Key 256-bit, 14 rounds).
* **Mode:** CTR (Counter Mode).
* **Architecture:** Tối ưu hóa cho hiệu suất hoặc diện tích (Iterative/Pipeline).
